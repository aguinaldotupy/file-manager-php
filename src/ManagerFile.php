...
class ManagerFile
{
     ...
     * @param bool $save_relation
     * @throws \Exception
     * @return \Illuminate\Database\Eloquent\Model|object|\Tupy\FileManager\Models\FileManager
     */
    public function imageUpload(\Closure $closure = null, $save_relation = true)
    {
        if ($this->file) {
     ...
     * @return \Illuminate\Database\Eloquent\Model|object|\Tupy\FileManager\Models\FileManager
     */
    public function uploadFile($save_relation = true)
    {
